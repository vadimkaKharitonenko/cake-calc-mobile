...
class ConsumablesList extends Component {
  ...
  chooseIngredient = (item) => {
    console.log(item);
    this.props.appActions.addConsumables(item);
    this.props.navigation.navigate('Consumables');
  };

  render() {
    this.ingredients = this.props.ConsumablesStore.map(( item, index ) => {
    ...
    return (
      <View style={styles.container}>
        <TouchableHighlight onPress={() => {this.props.navigation.navigate('Consumables')}}>
